          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 animate-fade-in animation-delay-300">
                <div className="bg-light-alt border border-border-light rounded-xl px-5 py-4">
                  <p className="font-serif text-2xl font-medium text-text-dark">
                    180+
                  </p>
      ...
      <section className="bg-light-alt py-20 px-6">
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-light-card border border-border-light rounded-2xl p-8 animate-fade-in animation-delay-100">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-5">
                <Target size={18} className="text-primary" />
              </div>
              <h3 className="font-serif text-xl font-medium text-text-dark mb-3">
                Our Mission
              </h3>
              <p className="text-sm text-text-muted leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {differences.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-light-card border border-border-light rounded-xl p-6 animate-fade-in ${
                    index === 0
                      ? 'animation-delay-100'
                      : index === 1
                        ? 'animation-delay-200'
