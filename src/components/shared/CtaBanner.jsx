...
export default function CtaBanner({
  ...
  return (
    <section
      ...
      className="relative isolate overflow-hidden bg-primary py-20 md:py-24"
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -top-16 left-16 -z-10 size-40 rotate-[44deg] bg-primary-foreground/5"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-20 right-24 -z-10 size-56 rotate-[39deg] bg-primary-foreground/5"
      />
